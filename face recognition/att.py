        ...
        while True:
            ...
            for(x,y,w,h) in faces :
                ...
                if confidence>77:
                    ...
                    cv2.putText(img,f"Roll:{r}, Click Enter to Mark Attendance",(x,y-5),cv2.FONT_HERSHEY_COMPLEX, 0.8,(255,0,0,),3)
                    cv2.putText(img,f"Department:{d} ",(x,y-30),cv2.FONT_HERSHEY_COMPLEX, 0.8,(255,0,0),3)
                    cv2.putText(img," Click Enter to Mark Attendance",(x,y+10),cv2.FONT_HERSHEY_COMPLEX, 0.8,(255,0,0,),3)
