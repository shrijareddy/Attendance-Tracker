...
class Student:
    def __init__(self,root):
        ...
        #search system
        Search_frame=LabelFrame(self.root,bg="white",fg="black")
        Search_frame.place(x=600,y=80,width=640,height=50)

        search_label=Label(Search_frame, text="Search By:", font=("Calibri Light",15), bg="white", fg="black")
        search_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)

        search_combo=ttk.Combobox(Search_frame,font=("arial",10),width=17, state="readonly")
        search_combo["values"]=("Select","Roll.NO","Name","Sem","Course","Year")
        search_combo.current(0)
        search_combo.grid(row=0,column=1)

        search_entry=ttk.Entry(Search_frame,font=("arial",10),width=17)
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        #search button
        search_btn=Button(Search_frame,text="Search",width=13 ,font=("arial",10),bg="lavender",fg="black")
        search_btn.grid(row=0,column=3,padx=4)

        #showall
        showall_btn=Button(Search_frame,text="Showall",width= 12,font=("arial",10),bg="lavender",fg="black")
        showall_btn.grid(row=0,column=4,padx=4)

        #table
        table_frame=LabelFrame(self.root,bg="white",fg="black")
        table_frame.place(x=600,y=150,width=640,height=475)
